      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">  
            <li><a class="dropdown-item" href="/diary/diary.jsp?want=1">1개씩</a></li>     
            <li><a class="dropdown-item" href="/diary/diary.jsp?want=5">5개씩</a></li>
            <li><a class="dropdown-item" href="/diary/diary.jsp?want=7">7개씩</a></li>
            <li><a class="dropdown-item" href="/diary/diary.jsp?want=10">10개씩</a></li>
            <li><a class="dropdown-item" href="/diary/diary.jsp?want=15">15개씩</a></li>
